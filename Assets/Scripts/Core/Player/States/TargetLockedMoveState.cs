...
{
    public class TargetLockedMoveState : IState
    {
        private readonly int _targetLockedAnimHash = Animator.StringToHash("TargetLockedMove");
        ...
        public TargetLockedMoveState(PlayerMover playerMover, PlayerInput playerInput, Animator animator, float animTransitionDuration, 
            float animDampTime, float moveSpeed, float rotationSpeed)
        {
